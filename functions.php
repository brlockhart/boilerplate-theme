...
function boilerplate_setup() {
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'boilerplate_custom_background_args',
			array(
...
function boilerplate_scripts() {
	wp_enqueue_style( 'boilerplate-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'boilerplate-style', 'rtl', 'replace' );

	wp_enqueue_script( 'boilerplate-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
